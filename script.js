class PomodoroTimer {
        ...
        if (!this.isRunning) {
            ...
            this.timerId = setInterval(() => {
                ...
                if (this.timeLeft <= 0) {
                    ...
                    this.pause();
                    const toggleButton = document.getElementById('mode-toggle');
                    this.timeLeft = parseInt(toggleButton.dataset.time) * 60;
                    this.updateDisplay();
                }
            }, 1000);
        }
    ...
    pause() {
        this.isRunning = false;
        this.startPauseButton.textContent = 'Run';
    ...
    reset() {
        this.pause();
        const toggleButton = document.getElementById('mode-toggle');
        const minutes = parseInt(toggleButton.dataset.time);
        this.setTime(minutes);
        this.start();  // Auto-start after reset
    }
